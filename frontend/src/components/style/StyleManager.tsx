...
const PreviewMessage = styled.div<{ style: ChatStyle }>`
  ...
  background-color: ${props => props.style.background.color}${Math.round(props.style.background.opacity * 255).toString(16).padStart(2, '0')};
  ...
  backdrop-filter: ${props => props.style.background.blur > 0 ? `blur(${props.style.background.blur}px)` : 'none'};
`;
